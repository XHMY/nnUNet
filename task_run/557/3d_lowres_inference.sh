...
-i "${nnUNet_raw_data_base}/nnUNet_raw_data/Task554_LungNoduleSE/imagesTs"  \
-o "/home/lvwei/project/MedicalSegmentation/data/Pred/Task554_LungNoduleSE/3d_lowres_557" \
-t 557 -m 3d_lowres \
