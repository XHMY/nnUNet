...
-i "${nnUNet_raw_data_base}/nnUNet_raw_data/Task558_LungNoduleGESemi/imagesTs"  \
-o "/home/lvwei/project/MedicalSegmentation/data/Pred/Task558_LungNoduleGESemi/3d_lowres_554_default" \
-t 554 -m 3d_lowres \
-tr nnUNetTrainerV2DTC \
